...
export const SCHEDULED_EVENTS: ScheduledEventDef[] = [
  ...
  { id:'ev018', triggerYear:2032, triggerMonth:12, category:'CRI', title:'Super Inflação de Insumos 📈', description:'Escalada geopolítica travou cargueiros de minério: Aço e Cobre dobram de preço no mercado internacional.', gameEvent:{ type:'crisis', statusEffect:'INFLACAO_GLOBAL', durationMonths:10, costToResolve:12_000_000_000, resourceMultipliers:{ aco:2.0, cobre:2.0 } } },
  ...
  // ── 2047 ──
  { id:'ev061', triggerYear:2047, triggerMonth:4, category:'CRI', title:'Greve dos Auditores Fiscais', description:'Paralisação dos auditores do fisco suspende incentivos fiscais e gera multas mensais por não conformidade contratual.', gameEvent:{ type:'politics', statusEffect:'GREVE_AUDITORES', durationMonths:5, costPerMonth:2_000_000_000, costToResolve:6_000_000_000 } },
  ...
  // ── 2060 ──
  { id:'ev100', triggerYear:2060, triggerMonth:4, category:'CRI', title:'Gripe Aviária — Segunda Onda', description:'Retorno do vírus H5N1 reduz o movimento de passageiros nas ferrovias por medidas preventivas de saúde pública.', gameEvent:{ type:'natural', statusEffect:'GRIPE_AVIARIA_2', durationMonths:6, revenueMultiplier:0.88 } },
  ...
  // ── 2068 ──
  { id:'ev124', triggerYear:2068, triggerMonth:4, category:'POS', title:'Fusão das Ferrovias Nacionais', description:'Consolidação das operações ferroviárias nacionais sob a marca RENIF cria eficiências de escala e aumenta a receita de toda a malha.', gameEvent:{ type:'neutral', statusEffect:'FUSAO_FERROVIAS', durationMonths:120, revenueMultiplier:1.12 } },
