...
export const SCHEDULED_EVENTS: ScheduledEventDef[] = [
  ...
  { id:'ev002', triggerYear:2027, triggerMonth:8, category:'CRI', title:'Escassez Nacional de Cimento', description:'Crise no setor de construção civil drenou os estoques nacionais. Todas as obras avançam mais devagar por falta de cimento no mercado.', gameEvent:{ type:'crisis', statusEffect:'ESCASSEZ_CIMENTO', durationMonths:4, costToResolve:15_000_000_000, constructionSlowFactor:1.5 } },
  ...
  { id:'ev011', triggerYear:2030, triggerMonth:8, category:'CRI', title:'Ataque Cibernético aos Sistemas 💻', description:'Hackers paralisaram os sistemas de bilhetagem e monitoramento de carga da RENIF. Toda receita mensal fica zerada enquanto os sistemas são restaurados.', gameEvent:{ type:'cyber', statusEffect:'CYBER_ATAQUE', durationMonths:3, costToResolve:20_000_000_000 } },
  ...
  { id:'ev018', triggerYear:2032, triggerMonth:12, category:'CRI', title:'Super Inflação de Insumos 📈', description:'Escalada geopolítica travou cargueiros de minério: Aço e Cobre dobram de preço no mercado internacional.', gameEvent:{ type:'crisis', statusEffect:'INFLACAO_GLOBAL', durationMonths:10, costToResolve:30_000_000_000 } },
  ...
  { id:'ev108', triggerYear:2062, triggerMonth:12, category:'CRI', title:'Greve dos Fiscais Ambientais', description:'Paralisação dos fiscais do IBAMA suspende novas licenças e gera multas mensais por obras em andamento sem aprovação renovada.', gameEvent:{ type:'env_delay', statusEffect:'GREVE_AMBIENTAIS', durationMonths:6, costPerMonth:3_000_000_000, costToResolve:18_000_000_000 } },
