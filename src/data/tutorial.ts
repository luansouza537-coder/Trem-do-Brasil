...
export const TUTORIAL_STEPS: TutorialStepDef[] = [
  ...
  {
    id: 'close_sidebar_balsa',
    title: '🗺️ Feche o painel',
    message: 'Toque no botão ✕ destacado para fechar o painel e acessar os botões de modo na barra inferior.',
    refKey: 'close-sidebar-btn',
    advanceOn: 'action',
    position: 'bottom',
  },
